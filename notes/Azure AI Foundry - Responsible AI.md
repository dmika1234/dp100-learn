...
![Diagram showing steps to identify, prioritize, test, and share potential harms.](./Map potential harms - Training _ Microsoft Learn_files/identify-harms.png)
...
![Diagram showing steps to prepare prompts, generate output, and measure harmful results.](./Measure potential harms - Training _ Microsoft Learn_files/measure-harms.png)
...
![Diagram showing the model, safety system, application, and positioning layers of a generative AI solution.](./Mitigate potential harms - Training _ Microsoft Learn_files/mitigate-harms.png)
