...
![Diagram of an interaction with a language model.](./Assess the model performance - Training _ Microsoft Learn_files/interact-model.png)
...
![Diagram of a chat flow using a language model.](./Assess the model performance - Training _ Microsoft Learn_files/chat-flow-diagram.png)
